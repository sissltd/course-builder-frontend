...
export default function KYCView() {
  ...
  const handleNext = () => {
    if (step === "personal") setStep("id-selection");
    else if (step === "id-selection") setStep("id-input");
    else if (step === "id-input") setStep("success");
  };
  ...
  return (
    <div className="flex flex-col min-h-screen animate-in fade-in duration-500 w-full relative">
        ...
        <div className="flex flex-col items-center flex-1 max-w-[500px] mx-auto w-full py-[60px] px-[20px]">
          ...
          <div className="w-full flex flex-col gap-[40px]">
            <div className="flex flex-col gap-[16px]">
              <AppInput label="First name" placeholder="Enter first name" required />
              <AppInput label="Last name" placeholder="Enter last name" required />
              <AppInput label="Date of birth" type="date" required />
              <AppInput label="Address" placeholder="Enter residential address" required />
            </div>
