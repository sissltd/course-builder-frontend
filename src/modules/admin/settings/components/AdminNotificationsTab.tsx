...
export const AdminNotificationsTab = () => {
  return (
    <div className="flex flex-col gap-[24px] w-full">
      <div>
        <h3 className="text-[24px] font-medium text-[#202020] tracking-[-0.48px] leading-[32px]">Notification settings</h3>
        <p className="text-[16px] font-normal text-[#606060] leading-[24px]">Configure how your events demonstrate</p>
      </div>

      <div className="flex flex-col gap-[32px]">
        <div className="border border-[#F0F0F0] p-[16px] rounded-[12px]">
          <span className="text-[14px] font-medium text-[#202020] tracking-[-0.28px] leading-[20px] block mb-[20px]">NOTIFICATION CHANNELS</span>
          <div className="flex flex-col gap-[20px]">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[16px] font-normal text-[#202020] tracking-[-0.32px] leading-[24px]">Email Notifications</p>
                <p className="text-[14px] font-normal text-[#606060] tracking-[-0.28px] leading-[20px]">Receive notifications via email</p>
              </div>
              <Toggle defaultChecked />
            </div>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[16px] font-normal text-[#202020] tracking-[-0.32px] leading-[24px]">In-app Notifications</p>
                <p className="text-[14px] font-normal text-[#606060] tracking-[-0.28px] leading-[20px]">Receive notifications in-app</p>
              </div>
              <Toggle defaultChecked />
            </div>
          </div>
        ...
        <div className="border border-[#F0F0F0] p-[16px] rounded-[12px]">
          <span className="text-[14px] font-medium text-[#202020] tracking-[-0.28px] leading-[20px] block mb-[20px]">SYSTEM</span>
          <div className="flex flex-col gap-[20px]">
            {[
        ...
        <div className="border border-[#F0F0F0] p-[16px] rounded-[12px]">
          <span className="text-[14px] font-medium text-[#202020] tracking-[-0.28px] leading-[20px] block mb-[20px]">PREFERENCE</span>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-[16px] font-normal text-[#202020] tracking-[-0.32px] leading-[24px]">Course Update</p>
              <p className="text-[14px] font-normal text-[#606060] tracking-[-0.28px] leading-[20px]">Notify admin when there&apos;s a change in status about a course</p>
            </div>
            <Toggle />
          </div>
        </div>
