...
export const StatCard = ({ icon, label, value, trend }: StatCardProps) => {
  return (
    <div className="border border-[#E8E8E8] bg-[#FDFDFD] flex flex-col h-[150px] items-start justify-between p-[16px] relative rounded-[12px] min-w-[200px] flex-1 shadow-[inset_0px_-4px_8px_0px_rgba(255,255,255,0.2),inset_0px_4px_8px_0px_rgba(255,255,255,0.16)]">
