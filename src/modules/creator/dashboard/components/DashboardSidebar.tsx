...
import { CreatorRoutes } from "@/lib/routes";
import { 
  Home2, 
  Book, 
  Notepad, 
...
const sidebarLinks = [
  { name: "Dashboard", href: CreatorRoutes.DASHBOARD, icon: Home2 },
  { name: "My Courses", href: CreatorRoutes.COURSES, icon: Book },
  { name: "Draft", href: CreatorRoutes.DRAFTS, icon: Notepad },
  { name: "Collaborators", href: CreatorRoutes.COLLABORATORS, icon: Profile2User },
  { name: "Wallet", href: CreatorRoutes.WALLET, icon: Wallet },
  { name: "Reservation", href: CreatorRoutes.RESERVATION, icon: Edit },
  { name: "Notifications", href: CreatorRoutes.NOTIFICATIONS, icon: Notification },
];

const bottomLinks = [
  { name: "Profile", href: CreatorRoutes.PROFILE, icon: User },
  { name: "Settings", href: CreatorRoutes.SETTINGS, icon: Setting2 },
  { name: "Help", href: CreatorRoutes.HELP, icon: I24Support },
];
